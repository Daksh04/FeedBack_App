...
import 'package:feedback_app/sixth.dart';

class FifthScreen extends StatefulWidget {
  final double rate;

  FifthScreen({required this.rate});
        ...
        child: Column(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Text(
                'Q5. How much the App is User Interactive?',
                style: TextStyle(
                  fontSize: 22.0,
            ...
            ElevatedButton.icon(
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => SixthScreen(rate: widget.rate + rating)));
              },
